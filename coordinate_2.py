...
def n_txt(img, n):
    img1 = Image.open("/home/hj/apple/apple_data/ver2/mix/val/" + img) #원본 이미지
    img_name = img.split(".")[0]
    img2 = Image.open(f'/home/hj/apple/apple_data/ver2/mix/0.3/{img_name}.jpg')
    tr =  img.split(".")[0] + ".txt"
    tr = txt_read("/home/hj/apple/apple_data/ver2/mix/val/" + tr)
...
all_list = os.listdir('/home/hj/apple/apple_data/ver2/mix/val')
